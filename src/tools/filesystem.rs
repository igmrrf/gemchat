...
impl Tool for ReadFile {
    ...
    fn description(&self) -> &str { "Reads the contents of a file" }
...
impl Tool for CreateFile {
    ...
    fn description(&self) -> &str { "Creates a new file with the given content" }
    fn parameters(&self) -> Value {
        json!({
            "type": "OBJECT",
            "properties": {
...
impl Tool for UpdateFile {
    ...
    fn description(&self) -> &str { "Updates an existing file by appending content" }
    fn parameters(&self) -> Value {
        json!({
            "type": "OBJECT",
            "properties": {
...
impl Tool for ListDirectory {
    ...
    fn description(&self) -> &str { "Lists files and subdirectories in a directory" }
    fn parameters(&self) -> Value {
        json!({
            "type": "OBJECT",
            "properties": {
